...
export default function NewsletterSignup() {
  ...
  return (
    <div className="space-y-2">
      <h3 className="text-sm font-bold text-[#3e5c32]">Newsletter</h3>
      ...
      <form className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-stretch" onSubmit={submit} noValidate>
        ...
        <button
          type="submit"
          disabled={pending}
          className="shrink-0 rounded-lg bg-[#27441d] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#1f3717] disabled:opacity-75"
        >
