...
export default function BackofficeLoginPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(caughtError instanceof Error ? caughtError.message : 'Falha ao autenticar com Neon Auth.');
    } finally {
  ...
  return (
    <main className="mx-auto min-h-[70vh] w-full max-w-md px-4 py-16 sm:px-6 lg:px-8">
      ...
      <p className="mt-3 text-sm text-stone-600">Use as credenciais Neon para aceder à área administrativa.</p>
