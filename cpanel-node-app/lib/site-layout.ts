  ...
  home: {
    ...
    explore: {
      ...
      links: [
        ...
        { label: 'Projetos', href: '/projetos', title: 'Projetos', description: 'Investigação e conservação', icon: 'FolderOpen' },
        { label: 'Biblioteca', href: '/biblioteca', title: 'Biblioteca', description: 'Publicações e documentos', icon: 'BookOpen' },
        { label: 'A Serra', href: '/serra-do-caramulo', title: 'A Serra', description: 'Flora, fauna e geologia', icon: 'Mountain' },
